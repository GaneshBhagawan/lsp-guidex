...
const Signup = () => {
  ...
  return (
    <div className="min-h-screen overflow-hidden bg-gradient-to-br from-slate-950 via-blue-950 to-slate-900 flex items-center justify-center px-4 py-10 relative">
      ...
      <div className="relative z-10 w-full max-w-md">
        ...
        <div className="backdrop-blur-2xl bg-white/5 border border-cyan-300/30 rounded-[32px] px-8 py-10 shadow-2xl shadow-cyan-500/10">
          ...
          {/* Success */}
          {success && (
            <div className="bg-green-500/20 border border-green-500/40 text-green-300 rounded-xl px-4 py-3 mb-5 text-sm">
              {success}
            </div>
          )}
